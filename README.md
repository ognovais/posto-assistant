...
<!-- ![Validação de componentes](./docs/tela-validacao.png) -->
<!-- ![Gerador de e-mail](./docs/tela-carga-full.png) -->

*(espaço reservado — print da tela principal)*

*(espaço reservado — print da tela de validação de componentes)*

*(espaço reservado — print da tela de geração de e-mail)*
